...
namespace Geometry
{
    ...
    public static class Geometry
    {
        ...
        /// 斜率计算
        /// </summary>
        /// <param name="pointx1">线段起始X</param>
        /// <param name="pointy1">线段起始Y</param>
        /// <param name="pointx2">线段结束X</param>
        /// <param name="pointy2">线段结束Y</param>
        /// <returns>角度</returns>
        public static double Angle(double pointx1, double pointy1, double pointx2, double pointy2)
        {
            double k = ((pointx1 - pointx2) / (pointy1 - pointy2));
        ...
        /// 斜率计算
        /// </summary>
        /// <param name="line">线段坐标结构体</param>
        /// <returns>角度</returns>
        public static double Angle(Line2D line)
        {
            double k = ((line.StartX - line.EndX) / (line.StartY - line.EndY));
            return Math.Atan(k) * 180 / Math.PI;
        }
        ...
        /// <returns>几何平面一般方程式Ax +By +Cz + D = 0，返回A,B,C,D</returns>
